//!!! for windows had to convert CGAL::CGAL_triangulation_precondition CGAL_precondition;
...
public:
 ...
 Delaunay_triangulation_2(const Gt& gt = Gt())
  : Triangulation_2<Gt,Tds>(gt) { hs_update_log ("Delaunay_triangulation_2"); hs_vps.push_back(std::pair<std::string, std::string> ("Delaunay_triangulation_2 Constructor",""));}
 ...
 {
  insert(first,last);
  hs_update_log ("Delaunay_triangulation_2 Constructor Input Iterators");
   hs_vps.push_back(std::pair<std::string, std::string> ("","Delaunay_triangulation_2 Constructor Input Iterators"));
 }
...
// auxilliary functions for remove
  ...
  bool incircle(int x, int j, int, int l, std::vector<Face_handle> &f,
                std::vector<Vertex_handle> &w, std::vector<int> &i)
  { hs_update_log ("empty");
    hs_vps.push_back(std::pair <std::string, std::string> ("","empty"));
...
public:
  ...
  {hs_update_log ("draw_dual");
    hs_vps.push_back(std::pair <std::string, std::string> ("","draw_dual"));
  ...
  insert(InputIterator first, InputIterator last)
#endif //CGAL_TRIANGULATION_2_DONT_INSERT_RANGE_OF_POINTS_WITH_INFO
  { hs_update_log ("insert2");
    hs_vps.push_back(std::pair <std::string, std::string> ("","insert2"));
...
private:
  ...
  {hs_update_log ("insert_with_info");
    hs_vps.push_back(std::pair <std::string, std::string> ("","insert_with_info"));
    size_type n = this->number_of_vertices();
...
public:
  ...
  insert(InputIterator first,
         ...
         typename boost::enable_if<
           ...
           > >::type* = nullptr)
  {hs_update_log ("insert3");
    hs_vps.push_back(std::pair <std::string, std::string> ("","insert3"));
  ...
  insert(boost::zip_iterator< boost::tuple<InputIterator_1,InputIterator_2> > first,
         ...
         typename boost::enable_if<
           ...
           >
         >::type* = nullptr)
  {hs_update_log ("insert4");
    hs_vps.push_back(std::pair <std::string, std::string> ("","insert4"));
  ...
  get_conflicts_and_boundary(const Point  &p,
                             ...
                             OutputItBoundaryEdges eit,
                             Face_handle start = Face_handle()) const
  {hs_update_log ("get_conflicts_and_boundary");
     hs_vps.push_back(std::pair <std::string, std::string> ("","get_conflicts_and_boundary"));
  ...
  get_conflicts (const Point  &p,
                 OutputItFaces fit,
                 Face_handle start= Face_handle()) const
  {hs_update_log ("get_conflicts");
     hs_vps.push_back(std::pair <std::string, std::string> ("","get_conflicts"));
  ...
  get_boundary_of_conflicts(const Point  &p,
                            OutputItBoundaryEdges eit,
                            Face_handle start= Face_handle()) const
  {hs_update_log ("get_boundary_of_conflicts");
     hs_vps.push_back(std::pair <std::string, std::string> ("","get_boundary_of_conflicts"));
...
private:
  ...
  {  hs_update_log ("propagate_conflicts");
     hs_vps.push_back(std::pair <std::string, std::string> ("","propagate_conflicts"));
  ...
  non_recursive_propagate_conflicts(const Point  &p,
                                    ...
                                    const int i,
                                    std::pair<OutputItFaces,OutputItBoundaryEdges> pit) const
  { hs_update_log ("non_recursive_propagate_conflicts");
     hs_vps.push_back(std::pair <std::string, std::string> ("","non_recursive_propagate_conflicts"));
...
protected:
  ...
  {hs_update_log ("restore_edges");
    hs_vps.push_back(std::pair <std::string, std::string> ("","restore_edges"));
    std::list<Edge> edges;
...
inline bool
Delaunay_triangulation_2<Gt,Tds>::test_conflict(const Point  &p, Face_handle fh) const
                                 {hs_update_log ("test_conflict");
                                  hs_vps.push_back(std::pair <std::string, std::string> ("","test_conflict"));
...
template < class Gt, class Tds >
inline bool
Delaunay_triangulation_2<Gt,Tds>::does_conflict(const Point  &p, Face_handle fh) const
                                    {hs_update_log ("does_conflict");
                                    hs_vps.push_back(std::pair <std::string, std::string> ("","does_conflict"));
                                      return test_conflict(p,fh);
                                    }

template < class Gt, class Tds >
inline bool
Delaunay_triangulation_2<Gt,Tds>::find_conflicts(const Point  &p, std::list<Face_handle>& conflicts, Face_handle start) const
                                  {hs_update_log ("find_conflicts");
                                       hs_vps.push_back(std::pair <std::string, std::string> ("","find_conflicts"));
...
template < class Gt, class Tds >
bool
Delaunay_triangulation_2<Gt,Tds>::is_valid(bool verbose, int level) const
                                  {hs_update_log ("is_valid");
                                     hs_vps.push_back(std::pair <std::string, std::string> ("","is_valid"));
...
Delaunay_triangulation_2<Gt,Tds>::nearest_vertex(const Point  &p, Face_handle f) const
                                  {hs_update_log ("nearest_vertex");
                                     hs_vps.push_back(std::pair <std::string, std::string> ("","nearest_vertex"));
...
template < class Gt, class Tds >
typename Delaunay_triangulation_2<Gt,Tds>::Vertex_handle
Delaunay_triangulation_2<Gt,Tds>::nearest_vertex_2D(const Point& p, Face_handle f) const
                                 {hs_update_log ("nearest_vertex_2D");
                                     hs_vps.push_back(std::pair <std::string, std::string> ("","nearest_vertex_2D"));
                                   CGAL_precondition(this->dimension() == 2);
                                   f = this->locate(p,f);
...
template < class Gt, class Tds >
typename Delaunay_triangulation_2<Gt,Tds>::Vertex_handle
Delaunay_triangulation_2<Gt,Tds>::nearest_vertex_1D(const Point& p) const
                                {hs_update_log ("nearest_vertex_1D");
                                    hs_vps.push_back(std::pair <std::string, std::string> ("","nearest_vertex_1D"));
                                  typename Geom_traits::Compare_distance_2
                                      compare_distance =  this->geom_traits().compare_distance_2_object();
                                  Vertex_handle nn;
...
template < class Gt, class Tds >
void
Delaunay_triangulation_2<Gt,Tds>::look_nearest_neighbor(const Point& p,Face_handle f,int i,Vertex_handle& nn) const
                                                       {hs_update_log ("look_nearest_neighbor");
                                                        hs_vps.push_back(std::pair <std::string, std::string> ("","look_nearest_neighbor"));
...
Delaunay_triangulation_2<Gt,Tds>::dual(Face_handle f) const
                                 {hs_update_log ("dual");
                                  hs_vps.push_back(std::pair <std::string, std::string> ("",s_dual));
...
template < class Gt, class Tds >
Object
Delaunay_triangulation_2<Gt,Tds>::dual(const Edge &e) const
                                 { hs_update_log ("dual");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("",s_dual2));
...
template < class Gt, class Tds >
inline Object
Delaunay_triangulation_2<Gt,Tds>::dual(const Edge_circulator& ec) const
                                  {hs_update_log ("dual");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("",s_dual));
                                    return dual(*ec);
                                  }
...
template < class Gt, class Tds >
inline Object
Delaunay_triangulation_2<Gt,Tds>::dual(const Finite_edges_iterator& ei) const
                                  {hs_update_log ("dual");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("",s_dual));
                                    return dual(*ei);
                                  }
...
{hs_update_log ("insert");
 hs_vps.push_back(std::pair <std::string, std::string> ("",s_insert));
  Locate_type lt;
  int li;
...
{hs_update_log ("push_back");
    hs_vps.push_back(std::pair <std::string, std::string> ("","push_back"));
  return insert(p);
}
...
{hs_update_log ("remove_and_give_new_faces");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_and_give_new_faces"));
...
{hs_update_log ("remove");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove"));
  int d;
...
remove_degree_init(Vertex_handle v, std::vector<Face_handle> &f,
                   std::vector<Vertex_handle> &w, std::vector<int> &i,
                   int &d, int &maxd)
{hs_update_log ("remove_degree_init");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree_init"));
  f[0] = v->face();d=0;
  do{
    i[d] = f[d]->index(v);
...
{hs_update_log ("remove_degree_triangulate");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree_triangulate"));
  switch (d) {
  case 3:
...
remove_degree_d(Vertex_handle v, std::vector<Face_handle> &,
                ...
                std::vector<int> &,int)
{hs_update_log ("remove_degree_d");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree_d"));
...
remove_degree3(Vertex_handle, std::vector<Face_handle> &f,
               std::vector<Vertex_handle> &, std::vector<int> &i)
                                {hs_update_log ("remove_degree3");
                                 hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree3"));
...
remove_degree4(Vertex_handle, std::vector<Face_handle> &f,
               std::vector<Vertex_handle> &w, std::vector<int> &i)
                {hs_update_log ("remove_degree4");
                 hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree4"));
...
remove_degree5(Vertex_handle v, std::vector<Face_handle> &f,
               std::vector<Vertex_handle> &w, std::vector<int> &i)
{hs_update_log ("remove_degree5");
   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree5"));
...
(
 ...
 int i0, int i1, int i2, int i3, int i4)
                                { hs_update_log ("remove_degree5_star");
  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree5_star"));
...
template < class Gt, class Tds >
void
Delaunay_triangulation_2<Gt,Tds>::remove_degree6(Vertex_handle v, std::vector<Face_handle> &f, std::vector<Vertex_handle> &w, std::vector<int> &i)
                                { hs_update_log ("remove_degree6");
                                  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree6"));
...
Delaunay_triangulation_2<Gt,Tds>::remove_degree6_star(
  ...
  int i0, int i1, int i2, int i3, int i4, int i5)
                                { hs_update_log ("remove_degree6_star");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree6_star"));
...
Delaunay_triangulation_2<Gt,Tds>::remove_degree6_N(
  ...
  int i0, int i1, int i2, int i3, int i4, int i5)
                                { hs_update_log ("remove_degree6_N");
                                  hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree6_N"));
...
Delaunay_triangulation_2<Gt,Tds>::remove_degree6_antiN(
  ...
  Vertex_handle &v3, Vertex_handle &, Vertex_handle &,
  int i0, int i1, int i2, int i3, int i4, int i5)
                                { hs_update_log ("remove_degree6_antiN");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree6_antiN"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree6_diamond( Vertex_handle &,
  Face_handle & f0, Face_handle & f1, Face_handle & f2,
  Face_handle & f3, Face_handle & f4, Face_handle & f5,
  Vertex_handle &v0, Vertex_handle &, Vertex_handle &v2,
  Vertex_handle &, Vertex_handle &v4, Vertex_handle &,
  int i0, int i1, int i2, int i3, int i4, int i5)
                                { hs_update_log ("remove_degree6_diamond");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree6_diamond"));
...
template < class Gt, class Tds >
void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7(Vertex_handle v,std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                {hs_update_log ("remove_degree7");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::rotate7(int j, std::vector<Vertex_handle> &w, std::vector<Face_handle> &f, std::vector<int> &i)
                                {hs_update_log ("is_delaunay_after_displacement");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","is_delaunay_after_displacement"));
                                  if(j==0) return;
                                  Face_handle ff=f[0];
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_star   (Vertex_handle &, int j, std::vector<Face_handle> &f, std::vector<Vertex_handle> &w, std::vector<int> &i)
                                { hs_update_log ("remove_degree7_star");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_star"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_zigzag (Vertex_handle &, int j, std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                 { hs_update_log ("remove_degree7_zigzag");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_zigzag"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_leftdelta(Vertex_handle &, int j, std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                {
                                 hs_update_log ("remove_degree7_leftdelta");
                                    hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_leftdelta"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_rightdelta(Vertex_handle &, int j, std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                {
                                  hs_update_log ("remove_degree7_rightdelta");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_rightdelta"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_leftfan(Vertex_handle &, int j,std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                {
                                  hs_update_log ("remove_degree7_leftfan");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_leftfan"));
...
template < class Gt, class Tds >
inline void
Delaunay_triangulation_2<Gt,Tds>::remove_degree7_rightfan(Vertex_handle &, int j,std::vector<Face_handle> &f,std::vector<Vertex_handle> &w, std::vector<int> &i)
                                {
                                  hs_update_log ("remove_degree7_rightfan");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","remove_degree7_rightfan"));
...
template <class Gt, class Tds >
typename Delaunay_triangulation_2<Gt,Tds>::Vertex_handle
Delaunay_triangulation_2<Gt,Tds>::move_if_no_collision(Vertex_handle v, const Point &p)
                                {
                                hs_update_log ("move_if_no_collision");
                                 hs_vps.push_back(std::pair <std::string, std::string> ("","move_if_no_collision"));
...
template <class Gt, class Tds >
typename Delaunay_triangulation_2<Gt,Tds>::Vertex_handle
Delaunay_triangulation_2<Gt,Tds>::move(Vertex_handle v, const Point &p)
                                { hs_update_log ("move");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","move"));
                                  CGAL_precondition(!this->is_infinite(v));
                                  if(v->point() == p) return v;
...
template <class Gt, class Tds >
bool
Delaunay_triangulation_2<Gt,Tds>::is_delaunay_after_displacement(Vertex_handle v, const Point &p) const
                                {hs_update_log ("is_delaunay_after_displacement");
                                   hs_vps.push_back(std::pair <std::string, std::string> ("","is_delaunay_after_displacement"));
                                  CGAL_precondition(!this->is_infinite(v));
                                  CGAL_precondition(this->dimension() == 2);
...
template <class OutputItFaces>
typename Delaunay_triangulation_2<Gt,Tds>::Vertex_handle
Delaunay_triangulation_2<Gt,Tds>::move_if_no_collision_and_give_new_faces(Vertex_handle v, const Point &p, OutputItFaces oif)
                               {
                                 hs_update_log ("move_if_no_collision_and_give_new_faces");
                                  hs_vps.push_back(std::pair <std::string, std::string> ("","move_if_no_collision_and_give_new_faces"));
